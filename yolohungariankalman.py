...
while True:
    ...
    # Add labels to indicate Kalman Filter and Hungarian Algorithm
    cv2.putText(frame, "Kalman Filter", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
    cv2.putText(frame, "Hungarian Algorithm", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 0), 2)
    cv2.imshow('YOLOv4 Detection with Object Tracking and Kalman Filtering', frame)
